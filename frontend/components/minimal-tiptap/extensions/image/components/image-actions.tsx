import { ClipboardCopyIcon, DownloadIcon, EllipsisIcon, LinkIcon, MoveDiagonalIcon } from "lucide-react";
...
const ActionItems: Array<{
  ...
  { key: "onView", icon: <MoveDiagonalIcon className="size-4" />, tooltip: "Visualizar" },
  { key: "onDownload", icon: <DownloadIcon className="size-4" />, tooltip: "Baixar" },
  { key: "onCopy", icon: <ClipboardCopyIcon className="size-4" />, tooltip: "Copiar" },
  { key: "onCopyLink", icon: <LinkIcon className="size-4" />, tooltip: "Copiar link", isLink: true },
];
